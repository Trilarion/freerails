...
public class KEY implements FreerailsSerializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2232658862900775814L;
	...
	/**
	 * Whether ownership of the objects is common to all Principals in the game.
	 */
	...
	/**
	 * @param shared
	 *            Whether the objects are common to all Principals in the game
	 */
