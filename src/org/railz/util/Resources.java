...
public final class Resources {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3498239306084923539L;
     ...
     * @param params
     *            The parameters to be passed into MessageFormat.format()
     */
    public static ResourceKey getResourceKey(String string, Serializable[] params) {
    ...
    static {
	try {
	    bundle = ResourceBundle.getBundle("org.railz.data.l10n.jfreerails");
     ...
     * @param defaultString
     *            The string to be localised. This will be returned as the
     *            default if no localised string is found
     * @param key
     *            The key to be searched for in the resource bundles. This can
    ...
    /**
     * Set an external resource bundle that is used as a back-up if the default
     * does not have a given resource
     */
