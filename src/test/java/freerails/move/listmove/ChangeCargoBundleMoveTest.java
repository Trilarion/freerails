...
public class ChangeCargoBundleMoveTest extends AbstractMoveTestCase {
    ...
    public void testMove() {
        ...
        before.setAmount(new CargoBatch(1, new Vector2D(2, 3), 4, 0), 5);
        after.setAmount(new CargoBatch(1, new Vector2D(2, 3), 4, 0), 8);
        ...
        getWorld().add(MapFixtureFactory.TEST_PRINCIPAL, WorldKey.CargoBundles, before.toImmutableCargoBundle());
    }
}