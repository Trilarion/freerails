...
public class TrainMotionExpt extends JComponent { 
	...
	public TrainMotionExpt(){
		...
		OneTileMoveVector[] trackPath = {EAST, SOUTH_EAST, SOUTH, SOUTH_WEST, WEST, NORTH_WEST, NORTH, NORTH_EAST};
		...
		AddTrainPreMove addTrain = new AddTrainPreMove(0, new int[0], from, principal, null);
