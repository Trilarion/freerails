...
/**
 * <p>Used to test the logging configuration.</p>
 * <p>Usage:<code> java -Djava.util.logging.config.file=logging.properties experimental.TestLogging</code></p>
 * <p>Make sure <code>logging.properties</code> is in the working directory.</p>
 *  @author Luke
 */
