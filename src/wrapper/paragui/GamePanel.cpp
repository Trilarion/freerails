...
PG_GradientWidget(parent->getWidget(), PG_Rect(x,y,w,h), "GradientWidget") {
  ...
  trackButton->SetIcon("./data/graphics/ui/buttons/build_track_up.png",
			"./data/graphics/ui/buttons/build_track_down.png");
  stationButton=new PG_Button(this,2,PG_Rect(35,400,25,25));
  stationButton->SetIcon("./data/graphics/ui/buttons/build_station_up.png",
			 "./data/graphics/ui/buttons/build_station_down.png");
}
