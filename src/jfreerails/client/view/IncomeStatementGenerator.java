...
/** Generates the income statement- note, its fields are read using reflection so don't change their
 * names.
 * @author Luke
 *
 */
public class IncomeStatementGenerator {
    ...
    IncomeStatementGenerator(ReadOnlyWorld w, FreerailsPrincipal principal) {
        ...
        profit = mailYtd.getAmount() + passengersYtd.getAmount() +
            ...
            trainMaintenanceYtd.getAmount() + trackMaintenanceYtd.getAmount() +
