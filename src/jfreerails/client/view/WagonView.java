...
public class WagonView extends JLabel implements View, ListCellRenderer {
	private static final long serialVersionUID = 3545233631011680820L;
	...
	public java.awt.Component getListCellRendererComponent(JList list,
		...
		if (typeID.getKey() == SKEY.ENGINE_TYPES) {
			i = vl.getTrainImages()
					.getSideOnEngineImage(typeID.getID(), height);
		...
		Dimension d = new Dimension(this.getIcon().getIconWidth(), this
