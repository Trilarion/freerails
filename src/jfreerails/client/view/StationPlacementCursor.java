...
public class StationPlacementCursor extends MouseInputAdapter {
	...
	public void propertyChange(PropertyChangeEvent e) {
	    ...
	    } else if (e.getPropertyName().equals(StationBuildModel.
	    ...
	    boolean enabled =
		stationBuildModel.getStationBuildAction().isEnabled();
	...
	stationBuildModel.getStationBuildAction().
	    addPropertyChangeListener(buildActionListener);
    }
}
