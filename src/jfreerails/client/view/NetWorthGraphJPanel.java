...
//        }
    ...
    public NetWorthGraphJPanel() {
        ...
        super();
        FONT = new java.awt.Font("Bookman Old Style",
...
//        setAppropriateScale();
    ...
    /** 
     * <p>Sets the value of scaleMax subject to the following constraints.</P>
     * <p>(1) scaleMax >= max, where max is the max net worth value.</p>
     * <p>(2) (scaleMax % 4) == 0</p>
     * <p>(3) if max >= 1,000, then (scaleMax % 4,000) == 0</p>
     * <p>(4) if max >= 1,000,000, then (scaleMax % 4,000,000) == 0</p>
     * <p>(5) if max >= 1,000,000,000, then (scaleMax % 4,000,000,000) == 0</p>
     */
