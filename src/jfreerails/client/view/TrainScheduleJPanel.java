...
public class TrainScheduleJPanel
	...
	implements ListCellRenderer, MoveReceiver {
	...
	private void previousActionPerformed(
		...
		//GEN-FIRST:event_previousActionPerformed
	...
	private void nextActionPerformed(
		java.awt.event.ActionEvent evt) { //GEN-FIRST:event_nextActionPerformed
		// Add your handling code here:
		if (wi.next()) {
			display();
		} else {
	...
	private void doneActionPerformed(
		java.awt.event.ActionEvent evt) { //GEN-FIRST:event_doneActionPerformed
		// Add your handling code here:
	...
	private void trainOrders1KeyPressed(
		java.awt.event.KeyEvent evt) { //GEN-FIRST:event_trainOrders1KeyPressed
		// Add your handling code here:
		if (evt.getKeyCode() == KeyEvent.VK_G) {
	...
	private void display() {
		...
		if (wi.getRowNumber() != WorldIterator.BEFORE_FIRST) {
			...
			while (!stations.isEmpty()
				&& null
					!= (trainOrders = (TrainOrders) stations.firstElement())) {
			...
			if (schedule.getOrderToGoto() == 0
				...
				setGotoStation(
					(TrainOrders) stations.get(schedule.getOrderToGoto() - 1));
			} else {
