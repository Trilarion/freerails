...
public class CompositeMoveTest extends AbstractMoveTestCase {
	...
	public void testMove() {
		...
		assertEquals("The stations should not have been add yet.", 0, world.size(KEY.STATIONS));
		assertDoMoveIsOk(compositeMove);
		assertEquals("The stations should have been add now.", 4, world.size(KEY.STATIONS));
