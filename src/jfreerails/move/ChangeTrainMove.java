...
public class ChangeTrainMove extends ChangeItemInListMove {
	...
	private ChangeTrainMove(int index, FreerailsSerializable before, FreerailsSerializable after) {
		super(KEY.TRAINS, index, before, after);		
	}

	public static ChangeTrainMove generateMove(int id, TrainModel before, int newEngine, int[] newWagons){
