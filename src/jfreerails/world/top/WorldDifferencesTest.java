...
public class WorldDifferencesTest extends TestCase {
	...
	public void testNonSharedLists() {
		...
		FreerailsSerializable fs = worldDiff.get(KEY.STATIONS, 0, player0
				.getPrincipal());
	...
	public void testUsingNullElements() {
		...
		WorldDifferences worldDiff = new WorldDifferences(underlyingWorld);
		assertEquals(station0, worldDiff.get(KEY.STATIONS, 0, player0
				.getPrincipal()));
		assertEquals(station1, worldDiff.get(KEY.STATIONS, 1, player0
				.getPrincipal()));
