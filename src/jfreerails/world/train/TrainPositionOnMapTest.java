    ...
    */
    public void testAddToHead() {
        ...
        b = TrainPositionOnMap.createInstance(new int[] {20, 30},
                new int[] {22, 33});
        c = TrainPositionOnMap.createInstance(new int[] {10, 30},
                new int[] {11, 33});

        d = b.addToHead(a);
        assertEquals(d, c);

        f = TrainPositionOnMap.createInstance(new int[] {40, 50},
                new int[] {44, 55});
    ...
    public void testCanAddToHead() {
        ...
        b = TrainPositionOnMap.createInstance(new int[] {20, 30},
                new int[] {22, 33});
        c = TrainPositionOnMap.createInstance(new int[] {30, 40},
                new int[] {33, 44});
    ...
    public void testEquals() {
        ...
        a = TrainPositionOnMap.createInstance(new int[] {10, 20},
                new int[] {11, 22});
        b = TrainPositionOnMap.createInstance(new int[] {10, 20},
                new int[] {11, 22});
        c = TrainPositionOnMap.createInstance(new int[] {30, 40},
                new int[] {33, 44});
