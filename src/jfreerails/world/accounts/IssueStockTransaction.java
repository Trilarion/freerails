...
public class IssueStockTransaction extends AddItemTransaction {
	...
	private IssueStockTransaction(Category category, int playerId,
	...
	public static IssueStockTransaction issueStock(int playerId, int quantity,
		...
		return new IssueStockTransaction(Transaction.Category.ISSUE_STOCK,
	...
	public static IssueStockTransaction sellStock(int playerId, int quantity,
		...
		return new IssueStockTransaction(Transaction.Category.SELL_STOCK,
				playerId, quantity, amount);
	}

	public static IssueStockTransaction buyPlayerStock(int playerId,
			int quantity) {
		// Buys another Players Stock, Uses another Category
		return new IssueStockTransaction(Transaction.Category.BUY_PLAYER_STOCK,
				playerId, quantity, new Money(0));
	}

	public static IssueStockTransaction sellPlayerStock(int playerId,
			int quantity) {
		// Sells another Players Stock, Uses another Category
		return new IssueStockTransaction(
				Transaction.Category.SELL_PLAYER_STOCK, playerId, quantity,
				new Money(0));
	}
