...
public interface Connection2Server {
     ...
     * the server since the last time this method or waitForObjectFromServer()
    ...
    /** Disconnect from the server.  When this method returns, calling isOpen()
     * on this object returns false <b>and</b> calling isOpen() on the corresponding
     * Connection2Client held by the server also returns false.
     * @throws IOException
     */
