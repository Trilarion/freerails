package jfreerails.config;

public class ClientConfig {

    public static final String GRAPHICS_PATH = "/jfreerails/client/graphics/";
    
    public static final String PATH_SOUNDS = "/jfreerails/client/sounds/";
