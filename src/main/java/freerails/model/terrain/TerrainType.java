...
public class TerrainType implements Serializable {
     ...
     * @param tileBuildCost
     */
    public TerrainType(int rgb, TerrainCategory terrainCategory, String terrainType, int rightOfWay, List<TileProduction> tileProduction, List<TileConsumption> tileConsumption, List<TileConversion> tileConversion, int tileBuildCost) {
     ...
     * details.
     */
    public TerrainType(TerrainCategory terrainCategory, String terrainType) {
        this.terrainType = terrainType;
        this.terrainCategory = terrainCategory;
        rgb = 0;
        rightOfWay = 0;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TerrainType)) return false;

        final TerrainType tileType = (TerrainType) obj;
