 ...
 * these classes. </p>
 * <strong>Properties of the classes</strong></p>
 * (1) The classes need to be serializable so that the game state can be sent
 ...
 * {@code freerails.world.FreerailsSerializable.}</p>
 * (2) The classes should override the equals method to test for logical equality.
 ...
 * (4) There should only be one chain of references leading from the world object
 ...
 * object.</p>
 * (5) Changes to game world objects should be done using Move objects. There are
 * more details on the <a href="../move/package-summary.html">move package overview</a>.</p>
 * (6) Where possible, game world elements should be immutable or composed of immutable
