...
public class AddStationMove extends CompositeMove {
     ...
     * @return
     */
    public static AddStationMove generateMove(UnmodifiableWorld world, String stationName, Vec2D location, Move upgradeTrackMove, FreerailsPrincipal principal) {
